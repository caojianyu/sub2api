...
type CostInput struct {
	...
	// configuration mistakes; callers may enable this only for an explicitly
	// free supplier operation.
...
// calculateUnitCost bills supplier-native metered quantities such as
// characters, seconds, voice enrollments, or embedding units.

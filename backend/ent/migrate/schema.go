...
var (
	...
	UsageLogsColumns = []*schema.Column{
		...
		{Name: "meter_cost", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
		...
		{Name: "meter_unit", Type: field.TypeString, Nullable: true, Size: 50},
		{Name: "meter_quantity", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(20,6)"}},
		{Name: "meter_unit_price", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(20,12)"}},
		{Name: "meter_detail", Type: field.TypeJSON, Nullable: true, SchemaType: map[string]string{"postgres": "jsonb"}},
		{Name: "rate_multiplier", Type: field.TypeFloat64, Default: 1, SchemaType: map[string]string{"postgres": "decimal(10,4)"}},

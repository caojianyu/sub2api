<template>
  ...
  <!-- Aliyun / DashScope logo mark (cloud) -->
  <svg v-else-if="platform === 'aliyun'" :class="sizeClass" viewBox="0 0 24 24" fill="currentColor">
    <path d="M18.8 9.2A6.8 6.8 0 0 0 5.5 7.7 5.2 5.2 0 0 0 6.2 18h11.9a4.4 4.4 0 0 0 .7-8.8ZM8.1 15.3a2.8 2.8 0 0 1-.4-5.6l.9-.1.2-.8a4.1 4.1 0 0 1 8.1.9v.9l.9.1a2.4 2.4 0 0 1-.1 4.7H8.1Z" />
  </svg>

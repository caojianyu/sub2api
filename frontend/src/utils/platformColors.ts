...
export type Platform = 'anthropic' | 'openai' | 'antigravity' | 'gemini' | 'grok' | 'aliyun'
...
const BADGE: Record<Platform, string> = {
  ...
  aliyun: 'bg-cyan-500/10 text-cyan-700 border-cyan-500/30 dark:text-cyan-300',
}
...
const BADGE_LIGHT: Record<Platform, string> = {
  ...
  aliyun: 'bg-cyan-500/10 text-cyan-700 dark:bg-cyan-500/10 dark:text-cyan-300',
}
...
const BORDER: Record<Platform, string> = {
  ...
  aliyun: 'border-cyan-500/20 dark:border-cyan-500/20',
}
...
const ACCENT_BAR: Record<Platform, string> = {
  ...
  aliyun: 'bg-gradient-to-r from-cyan-400 to-cyan-600',
}
...
const TEXT: Record<Platform, string> = {
  ...
  aliyun: 'text-cyan-700 dark:text-cyan-300',
}
...
const ICON: Record<Platform, string> = {
  ...
  grok: 'text-zinc-800 dark:text-zinc-200',
  aliyun: 'text-cyan-600 dark:text-cyan-300',
}
...
const BUTTON: Record<Platform, string> = {
  ...
  aliyun: 'bg-cyan-600 text-white hover:bg-cyan-700 active:bg-cyan-800 dark:bg-cyan-600/80 dark:hover:bg-cyan-600',
}
...
const DISCOUNT: Record<Platform, string> = {
  ...
  aliyun: 'bg-cyan-100 text-cyan-700 dark:bg-cyan-900/40 dark:text-cyan-300',
}
...
const GRADIENT: Record<Platform, string> = {
  ...
  aliyun: 'from-cyan-500 to-cyan-700',
}
...
function isPlatform(p: string): p is Platform {
  return p === 'anthropic' || p === 'openai' || p === 'antigravity' || p === 'gemini' || p === 'grok' || p === 'aliyun'
}
